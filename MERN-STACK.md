**MERN Stack** is a JavaScript Stack that is used for efficient development of full-stack Web Application. MERN Stack comprises of four technologies i.e.**MongoDB, Express, React and Node.js**
